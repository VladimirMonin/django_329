...
Вопросы:
1. Поиск по категории не происходит
2. Кастомное имя над фильтром катеории
3. Только Джанго Админка упорно ищет ID в таблице многие ко многим - остальным норм.

3. Самый простой способ - добавить ID в модель `Card`
