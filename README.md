...
Разработать структуру шаблонов для Django-приложения, включая базовый шаблон и наследуемые от него шаблоны для главной страницы, страницы "О проекте", каталога карточек и детального представления карточки. Необходимо обеспечить подключение статики, создание кликабельного меню и отображение карточек.